...
const Header: React.FC<HeaderProps> = ({ currentUser, users, onUserChange, onOpenAdmin, onLogout, notifications, onClearNotifications, onMarkAsRead }) => {
  ...
  return (
    <header className="bg-white border-b px-6 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm no-print">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-slate-800 tracking-tight">BRD Architect</h1>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          {isNotifOpen && (
            <div className="absolute right-0 mt-2 w-80 bg-white border rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
